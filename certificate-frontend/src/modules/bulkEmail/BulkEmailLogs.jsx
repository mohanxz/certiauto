  ...
  const handleRetryCampaign = async (campaignId) => {
    ...
    try {
      ...
      if (response && response.success) {
        ...
        fetchCampaignDetails(campaignId); // Refresh details
      }
    } catch (error) {
  ...
  const getStatusInfo = (campaign) => {
    ...
    if (successCount === totalCount && totalCount > 0) {
      ...
      return {
        ...
        icon: "fas fa-clock text-gray-500",
        label: "No Recipients",
      };
    } else {
      return {
          ...
          <div className="md:col-span-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          </div>
          ...
          filteredCampaigns.map((campaign) => {
            ...
            return (
              <React.Fragment key={campaign._id}>
                <div
                  className={`bg-white rounded-lg border shadow-sm overflow-hidden transition-all duration-200 cursor-pointer hover:shadow-md ${
                    isSelected
                      ...
                      <div className="flex-1">
                        <div className="flex items-start gap-3">
                          <div className="flex-shrink-0">
                            <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center shadow-sm">
                              <i
                                className={`${getTypeIcon(campaign.type)} text-lg`}
                              ></i>
                            </div>
                          </div>
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-wrap items-center gap-2 mb-2">
                              ...
                              >
                                <i
                                  className={`${statusInfo.icon} mr-1 ${statusInfo.label === "Processing" ? "animate-spin" : ""}`}
                                ></i>
                                {statusInfo.label}
                              </span>
                            </div>
